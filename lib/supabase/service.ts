...
export function createServiceClient() {
  ...
  // Default every table query + RPC to the dedicated `quiz` schema (this
  // project is shared with SundayChess, which owns `public`, and
  // SundayTurnering, which owns `turnering`).
